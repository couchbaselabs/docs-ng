...
- Ability to reset password for Administrator using the CLI command. See [cbreset_password Tool](http://docs.couchbase.com/couchbase-manual-2.5/cb-cli/#cbreset-password-tool).
