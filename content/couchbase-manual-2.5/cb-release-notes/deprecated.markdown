...
Windows | 32-bit operating system will be supported for development purposes only. | Will be deprecated in 3.0 
Centos 5 | Pre-Centos 5 versions will not be supported after Couchbase Server version 3.0. | Will be deprecated in a release post-3.0
Ubuntu 10.04 | Pre-Ubuntu 10.04 versions will not be supported after Couchbase Server version 3.0. | Will be deprecated in a release post-3.0

## REST API

REST API | URI | Description | Deprecated version 
-------- | --- | ----------- | ------------------
Server nodes  | /pools/nodes | URI for obtaining information about nodes in a Couchbase cluster. | Will be deprecated in 3.0
...
---- | --------- | ----------- | ------ 
cbepctl | flush_param flushall_enabled | The 'flushall_enabled' parameter is deprecated. | Deprecated in 2.???
