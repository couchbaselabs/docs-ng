 ...
 * couchbase-client-1.3.0.jar, or latest version available
...
```
libraryDependencies += "couchbase" % "couchbase-client" % "1.3.0"
```
...
dependencies {
  compile "com.couchbase.client:couchbase-client:1.3.0"
}
```
