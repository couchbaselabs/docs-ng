...
You can create a new bucket in Couchbase Web Console under the Data Buckets tab.
 ...
 1. Select a Bucket Type, either `Memcached` or `Couchbase`. See [Data
    ...
    for more information. The options that appear in this panel will differ based on
    your a bucket type you select.
     ...
     * **Disk Read-Write Concurrency**
       ...
       Writers](couchbase-manual-ready.html#couchbase-admin-tasks-mrw).
