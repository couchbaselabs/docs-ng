...
As of Couchbase Server 2.1.0+ you will need a root account to run this command
and collect all the server information needed. There are internal server files
and directories that this tool accesses which require root privileges.
...
As of Couchbase Server 2.1.0 you can backup only design documents from a cluster
