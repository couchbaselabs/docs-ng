...
There are several ways you can provide hostnames for Couchbase 2.1.0+. You
should set the hostname before you add the node to a cluster. You can provide a
hostname when you install a Couchbase Server 2.1.0 node, as you add it to an
