...
#cd ~/Desktop/docs-ng/
#java -jar ~/Desktop/throwdown.jar /Users/kzeller/Couchbase_docs/docs/Couchbase/products/couchbase/couchbase-manual-1.8/couchbase-manual-ready.xml ccouchbase-manual-1.8
...
make validate
make reformat
make couchbase-elastic-search.pdf
cd ~/Desktop/docs-ng/
...
cd /Users/kzeller/Couchbase_docs/docs/Couchbase/products/couchbase/couchbase-sdk-essentials
make depend
make validate
make reformat
make couchbase-sdk-essentials.pdf
cd ~/Desktop/docs-ng/
java -jar ~/Desktop/throwdown.jar /Users/kzeller/Couchbase_docs/docs/Couchbase/products/couchbase/couchbase-sdk-essentials/couchbase-sdk-essentials-ready.xml couchbase-sdk-essentials
